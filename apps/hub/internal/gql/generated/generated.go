...
func (ec *executionContext) _Health_status(ctx context.Context, field graphql.CollectedField, obj *models.Health) (ret graphql.Marshaler) {
...
func (ec *executionContext) _Health_version(ctx context.Context, field graphql.CollectedField, obj *models.Health) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) _Query_health(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalNHealth2ᚖgithubᚗcomᚋjohnᚑeeveeᚋgaiaᚋappsᚋhubᚋinternalᚋgqlᚋmodelsᚐHealth,
		true,
		true,
	)
}
...
func (ec *executionContext) marshalNHealth2githubᚗcomᚋjohnᚑeeveeᚋgaiaᚋappsᚋhubᚋinternalᚋgqlᚋmodelsᚐHealth(ctx context.Context, sel ast.SelectionSet, v models.Health) graphql.Marshaler {
	return ec._Health(ctx, sel, &v)
}

func (ec *executionContext) marshalNHealth2ᚖgithubᚗcomᚋjohnᚑeeveeᚋgaiaᚋappsᚋhubᚋinternalᚋgqlᚋmodelsᚐHealth(ctx context.Context, sel ast.SelectionSet, v *models.Health) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
